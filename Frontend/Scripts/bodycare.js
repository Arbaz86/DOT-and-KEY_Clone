...
let bodyScrub = async (scrubParent) => {
  try {
    let res = await fetch(
      "http://ec2-13-235-68-193.ap-south-1.compute.amazonaws.com:4000/bodycare/scrub"
    );
...
bodyScrub(scrubParent);

let bodySerum = async (serumParent) => {
  try {
    let res = await fetch(
      "http://ec2-13-235-68-193.ap-south-1.compute.amazonaws.com:4000/bodycare/serum"
    );
...
bodySerum(serumParent);

let bodyButter = async (butterParent) => {
  try {
    let res = await fetch(
      "http://ec2-13-235-68-193.ap-south-1.compute.amazonaws.com:4000/bodycare/butter"
    );
...
bodyButter(butterParent);

let bodyCombo = async (comboParent) => {
  try {
    let res = await fetch(
      "http://ec2-13-235-68-193.ap-south-1.compute.amazonaws.com:4000/bodycare/combo"
    );
...
let bodyCare = async () => {
  try {
    let res = await fetch(
      "http://ec2-13-235-68-193.ap-south-1.compute.amazonaws.com:4000/bodycare"
    );
