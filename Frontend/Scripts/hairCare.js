let background1_data = [
  {
    ...
    image:
      "https://cdn.shopify.com/s/files/1/0361/8553/8692/files/girl_1.png?v=1643013901",
    title: "CONTROL HAIRFALL",
  },
  {
    icon: "https://cdn.shopify.com/s/files/1/0361/8553/8692/files/dand.png?v=1643031643",
    image:
      "https://cdn.shopify.com/s/files/1/0361/8553/8692/files/girl_3.png?v=1643013978",
    title: "SCALP CARE",
  },
  {
    icon: "https://cdn.shopify.com/s/files/1/0361/8553/8692/files/88.png?v=1643031666",
    image:
      "https://cdn.shopify.com/s/files/1/0361/8553/8692/files/girl_2_5f178ee9-cbb6-4d93-81fe-248206564305.png?v=1643014000",
    title: "REPAIR DAMAGE",
  },
];
...
let items = [
  {
    image:
      "//cdn.shopify.com/s/files/1/0361/8553/8692/products/1.png?v=1642746025",
    rating: "4.9/5",
...
let slider_data = [
  {
    ...
    description:
      "Rich in fatty acids & antioxidants, avocado oil repairs dry and damaged hair by penetrating deep into the scalp & hair shaft",
  ...
  },
  {
    ...
    description:
      "Is rich in fatty acids that tame dry and frizzy hair and keep it hydrated. It also regulates oil production in the scalp",
    icon: "https://cdn.shopify.com/s/files/1/0361/8553/8692/files/Group_57.png?v=1643014587",
  },
  {
    ...
    description:
      "Topical application of salicylic acid strips away the outermost layer of the epidermis, penetrating in to dissolve dead skin cells & remove dandruff, flakes & scaly skin. It unclogs the hair follicles to prevent oil & product buildup, which also reduces itchiness & scalp irritation.",
  ...
  },
  {
    ...
    description:
      "AHAs like Glycolic & Lactic Acid helps exfoliate your scalp by removing dirt & dry skin build up, clearing dead skin cells, dandruff & sebum for a detox treatment while promoting cell turnover.",
  ...
  },
  {
    ...
    description:
      "ACV is a natural AHA, anti-fungal & antibacterial ingredient that soothes your scalp, decreases dandruff and yeast growth while keeping your scalp pH level balanced. It is also a natural conditioner that smoothens hair, controls frizz & adds shine.",
  ...
  },
  {
    ...
    description:
      "A known hydrator & a natural source of Vitamin E, it strengthens weak & damaged hair. It increases the hair elasticity to prevent rough breakage while restoring volume to dull, lifeless hair. It also contains fatty acids that naturally moisturize & lubricate the hair giving it a healthy lustre and shine.",
    icon: "https://cdn.shopify.com/s/files/1/0361/8553/8692/files/Group_57.png?v=1643014587",
  },
  {
    title: "Linoleic Acid",
    ...
    description:
      "Linoleic Acid keeps the scalp hydrated & healthy. It rebalances the hair growth cycle which in turn gives you strong and thick hair, hence reducing hair fall and loss.",
  ...
  },
  {
    ...
    description:
      "As a rich source of protein & amino acids, quinoa protein provides the hair with moisture & strength while repairing surface damage. It also boosts keratin production which strengthens the hair shaft to make damaged hair healthier & stronger. Quinoa Protein also contains Vitamin E that balances the production of natural oils in your hair to keep it soft & smooth.",
    icon: "https://cdn.shopify.com/s/files/1/0361/8553/8692/files/Group_46.png?v=1643014449",
  },
  {
    title: "Olive",
    ...
    description:
      "Olive oil is a natural emollient which adds softness and strength to hair. It penetrates deep into the hair shaft to smoothen the outer cuticle & preserve moisture from within.",
    icon: "https://cdn.shopify.com/s/files/1/0361/8553/8692/files/Group_57.png?v=1643014587",
  },
  {
...
import { createProductPage, createProductCard, mainDisp } from "./main.js";
